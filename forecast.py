...
def create_lagged_series(symbol, start_date, end_date, lags=5):
    ...
    number of lagged return from the prior trading days
    (lags defaults to 5 days (bars)). Trading volume,
    ...
    # Create the shifted lag series or prior trading period close values
